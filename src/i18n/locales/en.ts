export default {
  ...
  'file.skippedLfsTooLargeReason': 'LFS file exceeds configured max size ({max} MB)',
  'file.lfsDisabledReason': 'Git LFS support is disabled in settings',
  ...
  'settings.lfs': 'Git LFS',
  'settings.lfsEnabled': 'Enable Git LFS',
  'settings.lfsEnabledDesc': 'Sync LFS-tracked files as real content (GitHub API backend). When off, pointer files are left as text.',
  'settings.lfsMaxSize': 'Max LFS file size (MB)',
  'settings.lfsMaxSizeDesc': 'Skip LFS files larger than this to avoid running out of memory on mobile',
