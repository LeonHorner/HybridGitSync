export default {
  ...
  'file.skippedLfsTooLargeReason': 'LFS 文件超过配置的最大大小（{max} MB）',
  'file.lfsDisabledReason': '设置中已关闭 Git LFS 支持',
  ...
  'settings.lfsEnabled': '启用 Git LFS',
  'settings.lfsEnabledDesc': '将 LFS 跟踪的文件按真实内容同步（GitHub API 后端）。关闭时指针文件按文本处理。',
  'settings.lfsMaxSize': 'LFS 单文件上限（MB）',
  'settings.lfsMaxSizeDesc': '超过此大小的 LFS 文件将被跳过，避免移动端内存不足',
